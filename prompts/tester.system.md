...
- Reuse the exact claim id, including case, from prior evidence and the issue ledger only for the same behavior so that the ledger stays continuous. Use new stable snake_case ids for new behaviors.
